...
BETA_SABR = 0.0
SHIFT_SABR = 0.0
H_GRID = np.array([0.05, 0.10, 0.15])#, 0.20, 0.25, 0.30, 0.35, 0.4, 0.45, 0.5])#, 0.20, 0.25, 0.30])   # 0.05, 0.10, , 0.20, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50
...
USE_TIKHONOV = True
LAMBDA_CURVATURE = 10.0  # Tuning parameter for spatial smoothness. (e.g., 1.0 to 100.0)